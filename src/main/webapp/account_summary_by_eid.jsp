                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="width20 right numlist">
                                ...
                                <strong>Rs. <%=String.format("%.2f", estimatedAmount)%></strong>
                                <strong>Rs. <%=String.format("%.2f", receivedTotal)%></strong>
                                <strong>Rs. <%=String.format("%.2f", totalPaidExp)%></strong>
                                
                                <strong>Rs. <%=String.format("%.2f", (receivedTotal - totalPaidExp))%></strong>
