...
<h4 class="widgettitle">Edit Investment Details</h4>
 <form class="stdform stdform2" method="post" action="ProjectServlet">
					 ...
					 String name= pdao.getInvestorName(request.getParameter("id"));
					  ...
					  <tr>
						<td>
							...
							<div>
							 <div><input type="text" name="amount" id="amount" class="input-large" value="<%=request.getParameter("amount") %>" readonly="readonly"/></div>
							</div>
						</td>
						<td>
					  ...
					  <tr>
						<td>
							...
							<div>
							 <div><input type="text" name="new_amount" id="new_amount" class="input-large" value="" placeholder="0.0" required="required"/></div>
							</div>
						</td>
						<td>
						...
						<tr>
						<td>
							<span>New Promised Refund Amount</span>
							<div>
							<input type="text" name="new_pro_amount" id="new_pro_amount" class="" value="" placeholder="0.0" required="required"/>
							</div>
						</td>
					  </tr>
					  <tr>
					...
					<br>
					<br>
						<input type="hidden" name="todo" value="appendInvestment">
