...
<div class="mainwrapper">
    ...
    <div class="leftpanel">
         ...
         <ul class="nav nav-tabs nav-stacked">
            	...
            	<li class="nav-header"><a href="projects.jsp?proid=<%=session.getAttribute("project_id").toString() %>" class="btn btn-primary  alertinfo"><small>Back to Project</small></a></li>
          </ul>
