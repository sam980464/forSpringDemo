...
%>
					  ...
					  <tr>
						<td colspan=2>
							...
							<div>
								<input  value="<%=propertyDetailsBO.getKhatian_no() %>"  type="text" name="khatian" id="khatian" class="input-large" required="required" />
							</div>
						</td>
						<td colspan=2>
							<span>J.L. No</span>
...
%>  
					...
					<!--   <tr>
					  ...
					  <tr>
					  	<td>
					  	<span>Bigha</span>
					  	<input type="text" value="<%=String.format("%.2f", propertyDetailsBO.getBigha())%>" name="bigha" id="bigha" class="input-small" required="required" />
					  	</td>
					  	<td>
					  	<span>Katha</span>
					  	<input type="text"  value="<%=String.format("%.2f", propertyDetailsBO.getKatha())%>"  name="katha" id="katha" class="input-small" required="required" />
					  	</td>
					  	<td>
					  	<span>Chatak</span>
					  	<input type="text"  value="<%=String.format("%.2f", propertyDetailsBO.getChatak())%>"  name="chatak" id="chatak" class="input-small" required="required" />
					  	</td>
					  	<td>
					  	<span>Sq Ft</span>
					  	<input type="text"  value="<%=String.format("%.2f", propertyDetailsBO.getSq_ft())%>" name="sq_ft" id="sq_ft" class="input-small" required="required" />
					  	</td>
					  </tr>
					  <tr>
					    <td colspan=2>
							...
							<div>
								<input type="text" value="<%=String.format("%.2f", propertyDetailsBO.getTotal_sq_ft())%>" name="total_sq_ft" id="total_sq_ft" class="input-large" required="required" />
							</div>
						</td>
						<td colspan=2>
							<span>Total Sq. Mtr.</span>
							<div>
								<input type="text" value="<%=String.format("%.2f", propertyDetailsBO.getTotal_sq_mtr())%>"  name="total_sq_mtr" id="total_sq_mtr" class="input-large" required="required" />
							</div>
						</td>
					  </tr>
					  ...
					  <tr>
						<td colspan=2>
							...
							<div>
								<input type="text" value="<%= df.format(new java.util.Date()) %>"  name="date_of_deposit" id="date_of_deposit" class="input-large" required="required" /><a href="javascript:NewCal('date_of_deposit','yyyymmdd')" ><img src="resources/images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
							</div>
						</td>
						<td colspan=2>
							<span>Date Of Sanction</span>
							<div>
								<input type="text" value="<%= df.format(new java.util.Date()) %>" name="date_of_sanction" id="date_of_sanction" class="input-large" required="required" /><a href="javascript:NewCal('date_of_sanction','yyyymmdd')" ><img src="resources/images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
							</div>
						</td>
					  </tr>
					   <tr>
