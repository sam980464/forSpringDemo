...
<form class="stdform stdform2" method="post" action="ProjectServlet">
					<table width="100%" border="1" class="tbl">
					  ...
					  <td>
					  <span>Refund ID</span>
					  <div><input type="text" name="rid" id="rid" class="input-large" value="RF_00<%=request.getParameter("rid") %>" readonly="readonly"/></div>
					  </td>
					  </tr>
					  <tr>
						<td>
					...
					<br>
					<br>
						<input type="hidden" name="todo" value="editInvestmentRefund">
