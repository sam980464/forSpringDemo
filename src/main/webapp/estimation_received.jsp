...
<div class="beforePrintTable" ><p style="text-align:center;font-size:22px;">Estimation</p></div>
	...
	Invoice No : &nbsp;<b><%=request.getParameter("eid") %></b>
	</div>
	<% java.text.DateFormat df = new java.text.SimpleDateFormat("dd-MM-yyyy");
	  %>
	<div style="float:right;color:black;font-weight:bold">Date: <%=df.format(new java.util.Date()) %></div>
...
<h4 class="widgettitle" style="margin-top:10px;margin-button:10px">
 ...
 <table class="table table-bordered table-invoice-full">
                ...
                <thead>
                    <tr>
                        <th class="head0" style="color:black;font-weight:bold">Estimation Date</th>
                      ...
                      <!--   <th class="head1">Estimated Amount</th> -->
                        ...
                        <th class="head0" style="color:black;font-weight:bold">Estimated Amount</th>
                    </tr>
                </thead>
                <tbody>
    <% 
...
<div style="display:inline">Cheque No :<%=payment.getChecknoByPaymentId(payment_id)%></div>
<%} %>
</div>
...
<div>
<div style="display:inline;margin-left:15px">Customer's Signature</div>
<div style="float:right;margin-right:50px">Signature</div>
</div>
