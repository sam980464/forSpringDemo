...
%>             
<h4 class="widgettitle">Miscellaneous Expense List<b></b> </h4>
...
<%
 ...
 ArrayList<ArrayList<String>> investmentdetails= pdao.getMisEList(proid);
