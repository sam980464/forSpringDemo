                        ...
                        <tr class="gradeX">
                          <td class="aligncenter"><span class="center">
							...
							<td>
								...
								<a href="get_payment.jsp?cid=<%=estimateItem.getClientId() %>&estimateid=<%=estimateItem.getId()%>" class="color"><img src="resources/images/money.png" /></a>
							</td>
                        </tr>
<%
